...
<body>
    <section class="d-flex flex-column justify-content-between" id="hero">
                ...
                <div class="container-fluid"><a class="navbar-brand" href="#">PEDULI DIRI</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1" style="font-family: Montserrat, sans-serif;">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item"><a class="nav-link active pulse animated" href="#">ISI DATA PERJALANAN</a></li>
        ...
        <div data-aos="zoom-in-down" data-aos-duration="700" data-aos-delay="250" id="hero-content">
            <div class="container d-flex flex-column justify-content-center" id="hero-container">
                <form method="POST">
                    <div class="table-responsive text-center" id="table-form" style="margin-left: 230px;">
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input class="form-control" type="date" style="width: 460px;" name="tanggal"></td>
                                </tr>
                                <tr>
                                    <td class="text-start">Waktu</td>
                                    <td><input class="form-control" type="time" style="width: 460px;" name="waktu"></td>
                                </tr>
                                <tr>
                                    <td class="text-start">Lokasi</td>
                                    <td><input class="form-control" type="text" style="width: 460px;" name="lokasi"></td>
                                </tr>
                                <tr>
                                    <td class="text-start">Suhu Tubuh</td>
                                    <td><input class="form-control" type="text" style="width: 460px;" name="suhu"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="row">
                        <div class="col offset-xl-9"><button class="btn btn-primary btn-lg" data-bss-hover-animate="bounce" id="btn" type="submit" name="simpan">SIMPAN</button></div>
                    </div>
                </form>
            </div>
        </div>
